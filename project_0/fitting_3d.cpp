...
main (int argc, char *argv[])
{
  ...
  seg_1.setModelType (pcl::SACMODEL_SPHERE);
  ...
  viewer->addPointCloud<pcl::PointXYZRGB> (layer_cloud_rgb, "sample cloud");
...
*/
  ...
  viewer->addSphere(*coefficients_cylinder_1, "sphere");
